...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT_arrow( /* Qwerty */
    ...
    SC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH, SC_RSPC,
    KC_LCTL, KC_LGUI, KC_LALT,                   LT(_L2,KC_SPC),   LT(_L1,KC_SPC),  KC_LALT, KC_LEFT, KC_DOWN,  KC_RIGHT
  ),
  [_CM] = LAYOUT( /* Colemak */
  ...
  [_HD] = LAYOUT( /* Handsdown reference */
   ...
   OSM(MOD_LSFT), KC_X,    KC_M,    KC_L,    KC_D,    KC_B,    KC_Z,    KC_F,    KC_QUOT, KC_COMM,  KC_DOT, SC_RSPC,
    KC_LCTL, KC_LALT, KC_LGUI,                   LT(_L2,KC_SPC),  LT(_L1,KC_SPC),   KC_RALT, KC_QUOT,  TG(_L3)
  ),
  [_HDN] = LAYOUT_arrow( /* Handsdown NEU*/
      // Again, have to mess with the J key to make it work. Eugh
    KC_TAB,  KC_W,    KC_F,    KC_M,    KC_P,    KC_V,    KC_MINS,    KC_U,    KC_O,    KC_Y,    KC_K, KC_BSPC,
    LCTL_T(KC_ESC), KC_R,    KC_S,    KC_N,    KC_T,    KC_G,    KC_COMM,    KC_A,    KC_E,    KC_I,    KC_H,    LCTL_T(KC_J),
    SC_LSPO, KC_X,    KC_C,    KC_L,    KC_D,    KC_B,    KC_SLSH,    KC_DOT,    KC_Q, KC_QUOT,  KC_Z, SC_RSPC,
    LCTL_T(KC_ENT), KC_LGUI, KC_LALT,                   LT(_L2,KC_SPC),  LT(_L1,KC_SPC),   KC_LALT, KC_COLON,KC_QUOT,  KC_ENT
  ),
  [_L1] = LAYOUT( /* LAYER 1 */
    KC_GRAVE,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
    X(LAMBDA), KC_BSLS, KC_QUOT, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______,
    NK_TOGG, KC_ESC,  _______, KC_PSCR, _______, _______, _______, KC_MSTP, KC_MPLY, KC_MPRV, KC_MNXT, _______,
    TG(_L3), KC_LGUI, _______,                   KC_ENT, _______,                   _______, _______, _______
  ),
  [_L2] = LAYOUT( /* LAYER 2 */
      KC_GRAVE, QWERTY,  COLEMAK, HANDSDOWN, NEU, _______, _______, KC_7,    KC_8,    KC_9,    KC_0,    _______,
    KC_ESC,  KC_PIPE, KC_DQUO, KC_UNDS, KC_PLUS, L_CURBR, R_CURBR, KC_4,    KC_5,    KC_6,    KC_SCLN, KC_ENT,
    _______, _______, _______, _______, _______, _______, KC_0,    KC_1,    KC_2,    KC_3,    _______, _______,
	  TG(_L3), _______, _______,                   _______, KC_ENT,                   _______, _______, _______
  ),
  [_L3] = LAYOUT( /* LAYER 3 */
    ...
    KC_LSFT, KC_1,    KC_2,    KC_KP_0,    KC_KP_1,    KC_KP_2,    KC_KP_3,    KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
      TG(_L3), KC_LSFT, KC_B,                      KC_SPC,  LT(_L1,KC_SPC),                      _______, _______, _______
  )
};
